    ...
    function Plot(placeholder, data_, options_, plugins) {
            ...
            for (i = 0; i < series.length; ++i) {
                ...
                if (s.bars.show) {
                    ...
                    switch (s.bars.align) {
                        ...
                        default:
                            throw new Error(
                                "Invalid bar alignment: " + s.bars.align
                            );
                    }
            ...
            $.each(allAxes(), function (_, axis) {
                ...
                if (axis.reserveSpace)
                    margins[dir] = Math.ceil(
                        Math.max(
                            margins[dir],
                            (dir == "x" ? axis.labelWidth : axis.labelHeight) /
                                2
                        )
                    );
            });
        ...
        function setupGrid() {
            ...
            if (showGrid) {
                ...
                var fontDefaults = {
                    ...
                    size: Math.round(
                        0.8 *
                            (+placeholder.css("font-size").replace("px", "") ||
                                13)
                    ),
        ...
        function drawSeriesBars(series) {
            ...
            switch (series.bars.align) {
                ...
                default:
                    throw new Error(
                        "Invalid bar alignment: " + series.bars.align
                    );
            }
        ...
        function findNearbyItem(mouseX, mouseY, seriesFilter) {
            ...
            for (i = series.length - 1; i >= 0; --i) {
                ...
                if (s.bars.show && !item) {
                    ...
                    var barLeft =
                            s.bars.align == "left" ? 0 : -s.bars.barWidth / 2,
        ...
        function drawBarHighlight(series, point) {
            var highlightColor =
                ...
                barLeft =
                    series.bars.align == "left" ? 0 : -series.bars.barWidth / 2;
